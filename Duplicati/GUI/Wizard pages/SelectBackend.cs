...
namespace Duplicati.GUI.Wizard_pages
{
    public partial class SelectBackend : WizardControl
    {
        ...
        void SelectBackend_PageDisplay(object sender, PageChangedArgs args)
        {
            ...
            // Faig que per defecte -i única opció- hi hagi SSH
            ((RadioButton)BackendList.Controls[6]).Checked = true;
        ...
        private void BackendList_Paint(object sender, PaintEventArgs e)
        {
