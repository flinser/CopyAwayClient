...
namespace Duplicati.Library.Backend
{
    public partial class SSHUI : UserControl
    {
        ...
        void SSHUI_PageLoad(object sender, EventArgs args)
        {
            ...
            //Servername.Text = "192.168.1.11";
            
            //if (m_options.ContainsKey(FOLDER))
            //    Path.Text = m_options[FOLDER];
            //m_options[FOLDER] = "/homes/" + m_options[USERNAME];
            ...
            if (m_options.ContainsKey(PASSWORD))
                Password_show.Text = m_options[PASSWORD];          
            ...
            Password_show.AskToEnterNewPassword = !string.IsNullOrEmpty(m_options[INITIALPASSWORD]);
            Password_show.InitialPassword = m_options[INITIALPASSWORD];
        ...
        private bool ValidateForm()
        {
            ...
            if (Password_show.Text.Trim().Length <= 0)
            {
        ...
        private void label1_click(object sender, CancelEventArgs e)
        {

        }

        private void OpenSSHKeyFileDialog_FileOk(object sender, CancelEventArgs e)
        {
